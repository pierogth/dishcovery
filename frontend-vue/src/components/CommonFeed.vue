...
import TopRatedPreview from "@/components/TopRatedPreview.vue";
...
export default class CommonFeed extends Vue {
  ...
  @Prop({ required: true }) topRated!: IArticleList;
  ...
  get TopRated(): IArticle[] {
    console.log(this.topRated)
    return this.topRated.articles.map(
      article => this.articlesCache[article.slug] || article
    );
  }
